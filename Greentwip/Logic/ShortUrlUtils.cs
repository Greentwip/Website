...
namespace Greentwip.Logic
{
    class ShortUrlUtils
    {
        private string shorturl_chars_lcase = "abcdefgijkmnopqrstwxyz";
        private string shorturl_chars_ucase = "ABCDEFGHJKLMNPQRSTWXYZ";
        private string shorturl_chars_numeric = "23456789";
        ...
        public string PublicShortUrl(string short_url)
        {
            //return "http://" + ConfigurationManager.AppSettings["DomainName"].ToString() + "/" + short_url;
            return "http://" + "greentwip.com" + "/media/" + short_url;
        }

        public string InternalShortUrl(string short_url)
        {
            //return short_url.Replace("http://" + ConfigurationManager.AppSettings["DomainName"].ToString() + "/", "");
            return short_url.Replace("http://" + "greentwip.com" + "/media/", "");
        }
